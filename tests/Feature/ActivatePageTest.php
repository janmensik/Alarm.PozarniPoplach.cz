...
test('activate page rejects POST with invalid PIN code', function () {
    $_SERVER['REQUEST_METHOD'] = 'POST';
    $_SESSION['csrf_token'] = 'valid-token';
    $_POST = [
        'unit_id' => 123,
    ...
    // checkUnitPincode uses getResult
    $this->db->expects($this->any())->method('getResult')->willReturn(null);
...
test('activate page accepts POST with valid CSRF token and valid PIN code', function () {
    $_SERVER['REQUEST_METHOD'] = 'POST';
    $_SESSION['csrf_token'] = 'valid-token';
    $_POST = [
        'unit_id' => 123,
