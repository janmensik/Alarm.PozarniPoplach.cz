...
test('calendar api returns calendar events for authorized device', function () {
    ...
    $this->db->method('getRow')
        ->willReturnOnConsecutiveCalls(
            ['unit_id' => 1, 'refresh_token_hash' => hash('sha256', 'valid_token'), 'last_seen_ts' => null, 'ad_probability' => 100, 'ad_sticky_duration' => 240, 'current_ad_id' => null, 'ad_expires_at' => null]
        );
