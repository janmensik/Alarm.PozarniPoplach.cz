...
class Dispatch extends Modul
{
     ...
     * @param int|array|null $dispatch_id Unit's ID to check.
    ...
    public function getDispatch(int|array|null $dispatch_id = null): array|null
    {
        ...
        // OPTIMIZATION: If array is provided, use pre-fetched data to bypass redundant DB lookup via getId()
        if (is_array($dispatch_id)) {
            $data = $dispatch_id;
        } else {
