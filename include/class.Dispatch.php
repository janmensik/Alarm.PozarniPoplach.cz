...
class Dispatch extends Modul
{
     ...
     * identify unit by its pincode
     * @param int|null $unit_id Unit's ID to check.
     * @param bool $full_data Whether to return full dispatch data including vehicles (true) or just base data (false).
     * @return array|null Return dispatch data of the last dispatch for the given unit or any unit if null is provided, or null if not found.
     *
     */
