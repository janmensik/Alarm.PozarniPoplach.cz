...
class Ad extends Modul
{
     ...
     * @param array|null $cachedDeviceData Pre-fetched device data to save DB queries
     * @return array|null
     */
    public function getAdForDevice(string $deviceUuid, int $unitId, ?array $cachedDeviceData = null): array|null
    {
        $device = $cachedDeviceData;
        if (!$device || !array_key_exists('ad_probability', $device)) {
